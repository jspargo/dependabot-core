...
COCOAPODS_DEPRECATED_SPECS = fixture("cocoapods", "podspecs", "deprecated_podspecs.txt")
COCOAPODS_VERSION_YAML = fixture("cocoapods", "CocoaPods-version.yml")

FIXTURES_PATH = File.join("spec", "fixtures", "cocoapods")
ALL_VERSIONS_FILES = File.join(FIXTURES_PATH, "all_pods", "all_pods_versions_*.txt")
